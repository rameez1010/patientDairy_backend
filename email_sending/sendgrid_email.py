...
def sendgrid_email(to_emails: str, name: str):
    # Read the HTML content from the file
    with open("./email_sending/email.html", "r") as file:
...
def send_password_reset_email(to_email: str, name: str, reset_link: str):
    # Read the HTML content from the file
    with open("./email_sending/reset_password_email.html", "r") as file:
        html_content = file.read()
...
def send_doctor_otp_email(to_email: str, name: str, otp_code: str):
    # Read the HTML content from the file
    with open("./email_sending/doctor_otp_email.html", "r") as file:
        html_content = file.read()
