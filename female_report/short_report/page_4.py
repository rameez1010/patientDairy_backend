...
def page_4(results: List[BioMarker]):
    # c = canvas.Canvas("female_report/short_report/page_4.pdf", pagesize=letter)
    buffer = io.BytesIO()
    ...
    if calcium is not None:
        calcium_bar = convert_png_to_white_bg(
            "female_report/short_report/ANONA_bar.png"
        )
        c.drawImage(
            calcium_bar, 70, y_postion, width=480, height=35, preserveAspectRatio=False
        )
        c.setFillColor("#4b4b4b")
    ...
    if magnesiumS is not None:
        magnesiumS_bar = convert_png_to_white_bg(
            "female_report/short_report/ANOA_bar.png"
        )
        c.drawImage(
            magnesiumS_bar,
            70,
        ...
        c.drawString(
            116, y_postion + 5, str(magnesiumS.value) + " " + str(magnesiumS.unit)
        )
    ...
    if magnesiumR is not None:
        magnesiumR_bar = convert_png_to_white_bg(
            "female_report/short_report/ANOA_bar.png"
        )
        c.drawImage(
            magnesiumR_bar, 70, 345, width=480, height=35, preserveAspectRatio=False
        )
        c.setFillColor("#4b4b4b")
        c.setFont("Roboto-Regular", 11)
        c.drawString(116, y_postion + 20, "Magnesium RBC")
        c.drawString(
            116, y_postion + 5, str(magnesiumR.value) + " " + str(magnesiumR.unit)
        )
    ...
    if zinc is not None:
        zinc_bar = convert_png_to_white_bg("female_report/short_report/ANOA_bar.png")
        c.drawImage(
            zinc_bar, 70, y_postion, width=480, height=35, preserveAspectRatio=False
        )
        c.setFillColor("#4b4b4b")
        c.setFont("Roboto-Regular", 11)
    ...
    if ferritin is not None:
        ferritin_bar = convert_png_to_white_bg(
            "female_report/short_report/ANONA_bar.png"
        )
        c.drawImage(
            ferritin_bar, 70, y_postion, width=480, height=35, preserveAspectRatio=False
        )
        c.setFillColor("#4b4b4b")
        c.setFont("Roboto-Regular", 11)
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(280, y_postion + 35, "12.00")
        c.drawString(346, y_postion + 35, "90.00")
        c.drawString(412, y_postion + 35, "200.0")
        c.drawString(476, y_postion + 35, "272.0")
        ...
        if ferritin.value < 12:
            c.circle(260, y_postion + 17, 11, fill=1)
        elif 12 <= ferritin.value < 90:
            c.circle(325, y_postion + 17, 11, fill=1)
        elif 90 <= ferritin.value <= 200:
            c.circle(390, y_postion + 17, 11, fill=1)
        elif 200 < ferritin.value <= 272:
            c.circle(455, y_postion + 17, 11, fill=1)
        else:
            c.circle(515, y_postion + 17, 11, fill=1)
        y_postion -= 53
    ...
    if selenium is not None:
        selenium_bar = convert_png_to_white_bg(
            "female_report/short_report/ANOA_bar.png"
        )
        c.drawImage(
            selenium_bar, 70, y_postion, width=480, height=35, preserveAspectRatio=False
        )
        c.setFillColor("#4b4b4b")
        c.setFont("Roboto-Regular", 11)
        ...
        if selenium.value < 105.3:
            ...
            c.circle(347, y_postion + 17, 11, fill=1)
        elif 120.0 <= selenium.value <= 160.4:
            c.circle(430, y_postion + 17, 11, fill=1)
        else:
            c.circle(510, y_postion + 17, 11, fill=1)
