...
def page_10(results: List[BioMarker]):
    # c = canvas.Canvas("female_report/short_report/page_10.pdf", pagesize=letter)
    buffer = io.BytesIO()
    ...
    if fsh is not None:
        fsh_bar = convert_png_to_white_bg("female_report/short_report/AOA_bar.png")
        ...
        c.drawString(433, y_position + 35, "15.0")
    ...
    if lh is not None:
        lh_bar = convert_png_to_white_bg("female_report/short_report/AOA_bar.png")
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(328, y_position + 35, "2.0")
        c.drawString(433, y_position + 35, "12.0")
    ...
    if estradiol is not None:
        estradiol_bar = convert_png_to_white_bg("female_report/short_report/AOA_bar.png")
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(328, y_position + 35, "77.0")
        c.drawString(433, y_position + 35, "921.0")
        ...
        if estradiol.value < 77.0:
            c.circle(280, y_position + 17, 11, fill=1)
        elif 77.0 <= estradiol.value <= 921.0:
            c.circle(380, y_position + 17, 11, fill=1)
        else:
            c.circle(480, y_position + 17, 11, fill=1)
        y_position -= 53
    ...
    if progesterone is not None:
        progesterone_bar = convert_png_to_white_bg("female_report/short_report/AO_bar.png")
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(375, y_position + 35, "1.7")
    ...
    if testosterone is not None:
        testosterone_bar = convert_png_to_white_bg("female_report/short_report/NAOA_bar.png")
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(300, y_position + 35, "2.0")
        c.drawString(380, y_position + 35, "3.0")
        ...
        if testosterone.value <= 2.0:
            c.circle(270, y_position + 17, 11, fill=1)
        elif 2.0 <= testosterone.value < 3.0:
            c.circle(345, y_position + 17, 11, fill=1)
        elif 3.0 <= testosterone.value <= 10.0:
    ...
    if testosteronefree is not None:
        testosteronefree_bar = convert_png_to_white_bg("female_report/short_report/NOA_bar.png")
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(328, y_position + 35, "26.0")
        c.drawString(433, y_position + 35, "36.0")
        ...
        if testosteronefree.value < 196.0:
            c.circle(280, y_position + 17, 11, fill=1)
        elif 196.0 <= testosteronefree.value <= 636.0:
            c.circle(380, y_position + 17, 11, fill=1)
        else:
            c.circle(480, y_position + 17, 11, fill=1)
