...
def page_12(results: List[BioMarker]):
    # c = canvas.Canvas("female_report/short_report/page_12.pdf", pagesize=letter)
    buffer = io.BytesIO()
    ...
    if hemoglobin is not None:
        hemoglobin_bar = convert_png_to_white_bg("female_report/short_report/ANONA_bar.png")
        ...
        c.drawString(280, y_position + 35, "120.0")
        c.drawString(346, y_position + 35, "130.0")
        c.drawString(412, y_position + 35, "155.0")
        c.drawString(476, y_position + 35, "160.0")
        ...
        if hemoglobin.value < 120:
            c.circle(260, y_position + 17, 11, fill=1)
        elif 120 <= hemoglobin.value < 130:
            c.circle(325, y_position + 17, 11, fill=1)
        elif 130 <= hemoglobin.value <= 155:
            c.circle(390, y_position + 17, 11, fill=1)
        elif 155 < hemoglobin.value <= 160:
    ...
    if hematocrit is not None:
        hematocrit_bar = convert_png_to_white_bg("female_report/short_report/ANONA_bar.png")
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(280, y_position + 35, "0.35")
        c.drawString(346, y_position + 35, "0.37")
        c.drawString(412, y_position + 35, "0.44")
        c.drawString(476, y_position + 35, "0.45")
        ...
        if hematocrit.value < 0.35:
            c.circle(260, y_position + 17, 11, fill=1)
        elif 0.35 <= hematocrit.value <= 0.37:
            c.circle(325, y_position + 17, 11, fill=1)
        elif 0.37 <= hematocrit.value <= 0.44:
            c.circle(390, y_position + 17, 11, fill=1)
        elif 0.44 < hematocrit.value <= 0.45:
            c.circle(455, y_position + 17, 11, fill=1)
        else:
            c.circle(515, y_position + 17, 11, fill=1)
        y_position -= 53
    ...
    if wbc is not None:
        wbc_bar = convert_png_to_white_bg("female_report/short_report/AONA_bar.png")
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(295, y_position + 35, "4.0")
        c.drawString(380, y_position + 35, "10.0")
        c.drawString(460, y_position + 35, "11.0")
    ...
    if rbc is not None:
        rbc_bar = convert_png_to_white_bg("female_report/short_report/ANONA_bar.png")
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(280, y_position + 35, "4.0")
        c.drawString(346, y_position + 35, "4.3")
        c.drawString(412, y_position + 35, "4.8")
        c.drawString(476, y_position + 35, "5.1")
        ...
        if rbc.value < 4:
            c.circle(260, y_position + 17, 11, fill=1)
        elif 4 <= rbc.value < 4.3:
            c.circle(325, y_position + 17, 11, fill=1)
        elif 4.3 <= rbc.value <= 4.8:
            c.circle(390, y_position + 17, 11, fill=1)
        elif 4.8 < rbc.value <= 5.1:
            c.circle(455, y_position + 17, 11, fill=1)
        else:
            c.circle(515, y_position + 17, 11, fill=1)
        y_position -= 53
    ...
    if mcv is not None:
        mcv_bar = convert_png_to_white_bg("female_report/short_report/ANONA_bar.png")
    ...
    if mch is not None:
        mch_bar = convert_png_to_white_bg("female_report/short_report/AOA_bar.png")
        ...
        c.setFillColor("gray")
        c.setFont("Roboto-Regular", 9)
        c.drawString(328, y_position + 35, "27.5")
