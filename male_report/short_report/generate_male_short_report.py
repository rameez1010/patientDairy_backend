...
from male_report.short_report.generate_recommendation_page import (
    generate_recommendation_page,
    generate_supplements_page,
)
from male_report.short_report.page_0 import cover_page
from male_report.short_report.page_1 import page_1
from male_report.short_report.page_2 import page_2
from male_report.short_report.page_3 import page_3
from male_report.short_report.page_4 import page_4
from male_report.short_report.page_5 import page_5
from male_report.short_report.page_6 import page_6
from male_report.short_report.page_7 import page_7
from male_report.short_report.page_8 import page_8
from male_report.short_report.page_9 import page_9
from male_report.short_report.page_10 import page_10
from male_report.short_report.page_11 import page_11
from male_report.short_report.page_12 import page_12
from male_report.short_report.page_13 import page_13
from models.patient_models import BioMarkerGroup, BloodWorkBioMarkerGroup


def generate_male_short_report(
    report,
    ...
    # # Inflammation Markers-related pages
    if (
        "inflammation_Markers" in selectedBioMarkerGroups
        or "full" in selectedBioMarkerGroups
    ...
    # # Thyroid Function-related pagess
    if (
        "thyroid_Functions" in selectedBioMarkerGroups
        or "full" in selectedBioMarkerGroups
